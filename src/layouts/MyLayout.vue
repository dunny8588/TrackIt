        ...
        <q-btn small round flat
          ...
          <q-menu ref="popover-menu">
            <q-list link separator class="scroll" style="min-width: 200px">
              ...
              <q-item dense>
                <q-toggle @input="paramsChangeHandler" :disabled="!devices.length" v-model="params.needShowLBSPoints" icon="mdi-signal-cellular-outline" label="LBS points">
                  <q-tooltip>Show position points from LBS source</q-tooltip>
                </q-toggle>
              </q-item>
  ...
  data () {
    return {
      ...
      params: {
        ...
        needShowPlayer: true,
        needShowLBSPoints: true  // Add toggle for LBS points
      },
      devicesListSettings: {
